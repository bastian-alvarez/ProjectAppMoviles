                    ...
                    .addCallback(object : RoomDatabase.Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                ...
                                // Precargamos catálogo completo de juegos con imágenes de IGDB
                                val juegoDao = getInstance(context).juegoDao()
                                if (juegoDao.count() == 0) {
                                    Log.d("AppDatabase", "Seeding games...")
                                    val juegosSeed = listOf(
                                        JuegoEntity(nombre = "Super Mario Bros", precio = 29.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co3wdv.jpg", descripcion = "El clásico juego de plataformas", stock = 15, desarrollador = "Nintendo", fechaLanzamiento = "1985", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "The Legend of Zelda", precio = 39.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co3wfu.jpg", descripcion = "Épica aventura en Hyrule", stock = 8, desarrollador = "Nintendo", fechaLanzamiento = "1986", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Pokémon Red", precio = 24.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2h8d.jpg", descripcion = "Conviértete en maestro Pokémon", stock = 20, desarrollador = "Game Freak", fechaLanzamiento = "1996", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Sonic the Hedgehog", precio = 19.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co66jx.jpg", descripcion = "Velocidad supersónica", stock = 12, desarrollador = "Sega", fechaLanzamiento = "1991", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Final Fantasy VII", precio = 49.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co3p5s.jpg", descripcion = "RPG épico de Square Enix", stock = 5, desarrollador = "Square Enix", fechaLanzamiento = "1997", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Street Fighter II", precio = 14.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2odu.jpg", descripcion = "El mejor juego de lucha", stock = 10, desarrollador = "Capcom", fechaLanzamiento = "1991", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Minecraft", precio = 26.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co49x5.jpg", descripcion = "Construye tu mundo", stock = 25, desarrollador = "Mojang", fechaLanzamiento = "2011", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Call of Duty Modern Warfare", precio = 59.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1vke.jpg", descripcion = "Acción militar intensa", stock = 7, desarrollador = "Infinity Ward", fechaLanzamiento = "2019", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "FIFA 24", precio = 69.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co7gxp.jpg", descripcion = "El mejor fútbol virtual", stock = 18, desarrollador = "EA Sports", fechaLanzamiento = "2023", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "The Witcher 3 Wild Hunt", precio = 39.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co5ume.jpg", descripcion = "Aventura de Geralt de Rivia", stock = 6, desarrollador = "CD Projekt RED", fechaLanzamiento = "2015", categoriaId = 1, generoId = 1),
                                        ...
                                        JuegoEntity(nombre = "Red Dead Redemption 2", precio = 49.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1q1f.jpg", descripcion = "Western épico", stock = 11, desarrollador = "Rockstar Games", fechaLanzamiento = "2018", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Dark Souls III", precio = 39.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1vcv.jpg", descripcion = "Desafío extremo", stock = 8, desarrollador = "FromSoftware", fechaLanzamiento = "2016", categoriaId = 1, generoId = 1),
                                        JuegoEntity(nombre = "Grand Theft Auto V", precio = 29.99, imagenUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2lbd.jpg", descripcion = "Mundo abierto épico", stock = 22, desarrollador = "Rockstar Games", fechaLanzamiento = "2013", categoriaId = 1, generoId = 1),
